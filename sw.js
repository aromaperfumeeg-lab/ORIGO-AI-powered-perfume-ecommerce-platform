const CACHE_VERSION = "origo-static-v154";
const APP_SHELL = [
  ...
  "/runtime-loader.js?v=18", "/chunks/storefront-core.min.js?v=47",
  "/home-brand-navigation.js?v=6",
  "/appearance.css?v=86", "/origo-identity.css?v=20", "/no-effects.css?v=2",
  "/catalog-providers.min.js?v=1", "/app.min.js?v=204", "/deferred-modules.js?v=17",
