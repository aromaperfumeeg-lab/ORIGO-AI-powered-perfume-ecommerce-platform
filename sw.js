const CACHE_VERSION = "origo-static-v155";
const APP_SHELL = [
  ...
  "/runtime-loader.js?v=18", "/chunks/storefront-core.min.js?v=48",
  "/home-brand-navigation.js?v=6",
  "/appearance.css?v=86", "/origo-identity.css?v=20", "/no-effects.css?v=2",
  "/catalog-providers.min.js?v=1", "/app.min.js?v=205", "/deferred-modules.js?v=18",
