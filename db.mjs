...
export function upsertProduct(input) {
  ...
  `).run(
    ...
    JSON.stringify(Array.isArray(input.notesAr) ? input.notesAr.slice(0, 30) : []),
    JSON.stringify(Array.isArray(input.notesEn) ? input.notesEn.slice(0, 30) : []),
    price,
